...
BOOK_PATH = PACKAGE_DIR / "ArmoredGearFlySlight_graphics_review.ecbmps"
...
def compile_book(page_args: list[str], compiler_path: Path) -> None:
    ...
    command = [str(compiler_path), "-o", str(BOOK_PATH), "-t", "Armored Gear: Fly Slight Graphics Review", "-a", "GitHub Copilot"] + page_args
    subprocess.run(command, check=True)


def main() -> int:
    parser = argparse.ArgumentParser(description="Build the Armored Gear: Fly Slight graphics review package.")
