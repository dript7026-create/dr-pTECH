...
`PROGHONORAI` is the combat-routing module that shapes how passage channels feed into game logic. It is intentionally standalone so any Game Boy or non-Game Boy gameplay layer can query it without depending on Farmer's Feather internals.
