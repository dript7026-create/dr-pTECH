...
static const unsigned char sprite_tiles[] = {
    
};
...
static uint8_t profile_has_data(uint8_t profile_index) {
    SaveSlot slot;
    ENABLE_RAM;
    SWITCH_RAM(0);
...
static void erase_profile_slot(uint8_t profile_index) {
    SaveSlot slot;
...
static void render_enemies(void) {
    ...
    for (index = 0u; index < MAX_ENEMIES; ++index) {
        ...
        if (sprite_id > MAX_ENEMIES) break;
        {
            uint8_t screen_x;
            uint8_t screen_y;
            screen_x = (uint8_t)(g_enemies[index].x - g_camera_x) + 8u;
            screen_y = (uint8_t)(g_enemies[index].y - g_camera_y) + 16u;
            if (screen_x < 8u || screen_x > 168u || screen_y < 16u || screen_y > 152u) {
                ...
                set_sprite_tile(sprite_id, (g_enemies[index].type == ENEMY_BOSS) ? 5u : 4u);
            }
        }
        ++sprite_id;
    }
