...
namespace
{
const wchar_t *kWindowClass = L"InnsmouthIslandWindow";
const wchar_t *kWindowTitle = L"InnsmouthIsland";
...
void startOpeningSequence()
{
    ...
    setNotification(L"The tide leaves you on the black shore of InnsmouthIsland.");
}
...
void drawTitle(Graphics &graphics, HDC hdc, RECT clientRect)
{
    ...
    drawTextLine(hdc, 88, 74, RGB(248, 250, 252), L"InnsmouthIsland");
    drawTextLine(hdc, 88, 106, RGB(198, 206, 214), L"Dark ooze-punk chiaroscuro Lovecraftian action demo.");
...
void drawOpening(Graphics &graphics, HDC hdc, RECT clientRect)
{
    ...
    drawTextLine(hdc, 76, 66, RGB(244, 247, 250), L"InnsmouthIsland Opening");
...
void drawVictory(HDC hdc, RECT clientRect)
{
    ...
    FrameRect(hdc, &panel, (HBRUSH)GetStockObject(WHITE_BRUSH));
    drawTextLine(hdc, panel.left + 28, panel.top + 24, RGB(246, 248, 250), L"InnsmouthIsland Cleared");
