...
1. Read the top-level README for system intent.
2. Review the core C API and smoke test.
3. Review the sample manifest and the generated validation bundle.
4. Review Pertinence Tribunal as the scaled example.
5. Finish with the validation snapshot to confirm current status.
